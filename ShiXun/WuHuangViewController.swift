...
class WuHuangViewController: UIViewController {
    @IBOutlet weak var WuHuang: UIScrollView!
    ...
    override func viewDidLoad() {
        ...
        // 设置滚动视图的内容尺寸
        WuHuang.contentSize = CGSize(width: 3840.0 / 2.6, height: 2400.0 / 2.6)
        
        // 隐藏水平与垂直指示条
        WuHuang.showsVerticalScrollIndicator = false
        WuHuang.showsHorizontalScrollIndicator = false
        
        // 创建一个图片对象
        let image = UIImage(named: "吾皇的狗.jpg")
        
        // 创建图片视图对象
        let imageView = UIImageView(frame: CGRect(x: 0, y: 0, width: 1440.0 / 2.6, height: 1000.0 / 2.6))
        imageView.image = image
        
        // 将图片视图添加到滚动视图
        WuHuang.addSubview(imageView)
    }
