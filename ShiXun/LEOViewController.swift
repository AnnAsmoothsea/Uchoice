...
class LEOViewController: UIViewController {
    ...
    @IBOutlet weak var LEO: UIScrollView!
    ...
    override func viewDidLoad() {
        ...
        // 设置滚动视图的内容尺寸
        LEO.contentSize = CGSize(width: 3840.0 / 2.6, height: 2400.0 / 2.6)
        
        // 隐藏水平与垂直指示条
        LEO.showsVerticalScrollIndicator = false
        LEO.showsHorizontalScrollIndicator = false
        
        // 创建一个图片对象
        let image = UIImage(named: "LEO.jpg")
