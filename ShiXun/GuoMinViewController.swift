...
class GuoMinViewController: UIViewController {

    @IBOutlet weak var GuoMin: UIScrollView!
    ...
    override func viewDidLoad() {
        ...
        // 设置滚动视图的内容尺寸
        GuoMin.contentSize = CGSize(width: 3840.0 / 2.6, height: 2400.0 / 2.6)
        
        // 隐藏水平与垂直指示条
        GuoMin.showsVerticalScrollIndicator = false
        GuoMin.showsHorizontalScrollIndicator = false
        
        // 创建一个图片对象
        let image = UIImage(named: "老岳父.jpg")
